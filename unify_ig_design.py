...
# Post 2
content = re.sub(
    r'<blockquote class="instagram-media w-full" data-instgrm-permalink="https://www.instagram.com/p/Da23OGMgfPq/.*?</blockquote>',
    create_ig_link("Da23OGMgfPq", "ig_2.jpg"),
    content
)

# Post 4
content = re.sub(
    r'<blockquote class="instagram-media w-full hidden md:block" data-instgrm-permalink="https://www.instagram.com/p/DZazje7AODJ/.*?</blockquote>',
    create_ig_link("DZazje7AODJ", "ig_4.jpg", "hidden md:block"),
    content
)

# Post 5
content = re.sub(
    r'<blockquote class="instagram-media w-full hidden md:block" data-instgrm-permalink="https://www.instagram.com/p/DY0dgwdxdim/.*?</blockquote>',
    create_ig_link("DY0dgwdxdim", "ig_5.jpg", "hidden md:block"),
    content
)
...
print("Unified all Instagram posts to use the custom image design.")
